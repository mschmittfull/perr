...
def main(argv):
    ...
    if False:
        ...
        opts['ssseed'] = opts_update_dict.get(
            'ssseed', 1000 + opts['sim_seed'])  # seed used to draw subsample
    ...
    if False:
        ...
        opts['ssseed'] = opts_update_dict.get(
            'ssseed', 10000 + opts['sim_seed'])  # seed used to draw subsample
        opts['sim_Nptcles'] = 2048
        opts['sim_boxsize'] = 1380.0
        opts['sim_wig_now_string'] = 'wig'
        # scale factor of simulation snapshot (only used to rescale deltalin -- do not change via arg!)
        ...
        if True:
            ...
            opts['ext_grids_to_load']['deltalin'] = {
                ...
                'rhox_ms_binary',
                'fname':
                'tpmsph_ic.bin._rhoparams_PMGRID%d_MASS0.000to20.000_real4.rhogrid_x'
                % opts['Ngrid'],
                'scale_factor':
                1.0 / (1.0 + 75.0)  #For RunPB, a_init=1/(1+75)
            }
        if True:
            # deltaZA.
            opts['ext_grids_to_load']['deltaZA'] = {
                ...
                'rhox_ms_binary',
                'fname':
                'tpmsph_%.4f_za.bin._rhoparams_PMGRID%d_MASS0.000to20.000_real4.rhogrid_x'
    ...
    if opts['sim_name'] == 'jerryou_baoshift':
        ...
        if True:
            ...
            if False:
                ...
                opts['cats']['delta_h'] = {
                    'in_fname':
                    "fof_%.4f.hdf5_BOUNDS_log10M_12.8_13.8.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            if True:
                ...
                opts['cats']['delta_h'] = {
                    'in_fname':
                    "fof_%.4f.hdf5_WithMassCols.hdf5_BOUNDS_log10M_11.8_16.0.hdf5"
                    % opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            if True:
                ...
                opts['cats']['delta_h_M11.8-12.8'] = {
                    'in_fname':
                    "fof_%.4f.hdf5_BOUNDS_log10M_11.8_12.8.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
                ...
                opts['cats']['delta_h_M13.8-14.8'] = {
                    'in_fname':
                    "fof_%.4f.hdf5_BOUNDS_log10M_13.8_14.8.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
                opts['cats']['delta_h_M14.8-16.0'] = {
                    'in_fname':
                    "fof_%.4f.hdf5_BOUNDS_log10M_14.8_16.0.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            ...
            if opts['Ngrid'] >= 256:
                opts['cats']['delta_m'] = {
                    'in_fname':
                    "sub_%.4f_0.01_ssseedX.hdf5" % opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            else:
                ...
                opts['cats']['delta_m'] = {
                    'in_fname':
                    "sub_%.4f_0.01_ssseedX.hdf5_bw_sr0.171.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            ...
            opts['cats']['delta_h'] = {
                ...
                'in_fname':
                'fof_%.4f.hdf5_BOUNDS_log10M_11.0_12.0.hdf5_UNICAT_baseb1-1.0-R0.0_baseS-DHBb1_MS-DHU-1.000000_Ng%d.hdf5'
                % (opts['sim_scale_factor'], opts['Ngrid']),
                'weight_ptcles_by':
                'Mass'
            }
            ...
            opts['cats']['delta_m'] = {
                'in_fname':
                "sub_%.4f_idmod_101_0.hdf5_BOUNDS_None.hdf5_UNICAT_baseb1-1.0-R0.0_baseS-DHBb1_MS-DHU-1.000000_Ng%d.hdf5"
                % (opts['sim_scale_factor'], opts['Ngrid']),
                'weight_ptcles_by':
                'Mass'
            }
            ...
            opts['cats']['delta_m_matched_subsample'] = {
                ...
                'in_fname':
                "sub_%.4f_idmod_101_0.hdf5_sub0.000328.hdf5_BOUNDS_None.hdf5_UNICAT_baseb1-1.0-R0.0_baseS-DHBb1_MS-DHU-1.000000_Ng%d.hdf5"
                % (opts['sim_scale_factor'], opts['Ngrid']),
                'weight_ptcles_by':
                'Mass'
            }
        ...
        if True:
            ...
            if False:
                ...
                opts['cats']['delta_h'] = {
                    'in_fname':
                    "tpmsph_%.4f.fofp.ascii.ms_nbkfmt.hdf5_BOUNDS_log10M_13.8_14.8.hdf5"
                    % opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            if True:
                ...
                opts['cats']['delta_h'] = {
                    'in_fname':
                    "tpmsph_%.4f.fofp.ascii.ms_nbkfmt.hdf5_WithMassCols.hdf5_BOUNDS_log10M_11.8_16.0.hdf5"
                    % opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
            ...
            if opts['Ngrid'] < 256:
                ...
                opts['cats']['delta_m'] = {
                    'in_fname':
                    "tpmsph_%.4f.ms_subsample0.01_ssseedX_nbkfmt.hdf5_bw_sub0.000158.hdf5"
                    % (opts['sim_scale_factor']),
                    'weight_ptcles_by':
                    None
                }
                ...
                opts['cats']['delta_m'] = {
                    'in_fname':
                    "tpmsph_%.4f.ms_subsample0.01_ssseedX_nbkfmt.hdf5" %
                    (opts['sim_scale_factor']),
                    'weight_ptcles_by':
                    None
                }
            ...
            opts['cats']['delta_m_matched_subsample'] = {
                'in_fname':
                "tpmsph_%.4f.ms_subsample0.01_ssseedX_nbkfmt.hdf5_bw_sr0.0082.hdf5"
                % (opts['sim_scale_factor']),
                'weight_ptcles_by':
                None
            }
        ...
        if False:
            if opts['Ngrid'] >= 256:
                opts['cats']['delta_m_subsample'] = {
                    'in_fname':
                    "snap_%.4f_sub_bw_sr0.025_ssseedX.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
                ...
                opts['cats']['delta_m_subsample'] = {
                    'in_fname':
                    "snap_%.4f_sub_bw_sr0.00025_ssseedX.hdf5" %
                    opts['sim_scale_factor'],
                    'weight_ptcles_by':
                    None
                }
    ...
    if False:
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=['deltalin', 'deltalin_SHIFTEDBY_deltalin'],
                    field_to_smoothen_and_square=None,
                    quadratic_sources=[],
                    target_field='delta_m',  ## match to nonlinear DM
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=[
                        '1_SHIFTEDBY_deltalin', 'deltalin_SHIFTEDBY_deltalin',
                    ...
                    target_field='delta_m',  ## match to nonlinear DM
                    save_bestfit_field=
                    'hat_delta_m_T_1delta12G23_SHIFTEDBY_deltalin'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='delta_m',  ## match to nonlinear DM
                    save_bestfit_field=
                    'hat_delta_m_T_delta12G23_SHIFTEDBY_deltalin'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='delta_m',  ## match to nonlinear DM
                    save_bestfit_field=
                    'hat_delta_m_T_1deltaG23_SHIFTEDBY_deltalin'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='1_SHIFTEDBY_deltalin',  ## match to deltaZ
                    save_bestfit_field=
                    'hat_deltaZ_T_delta12G2_SHIFTEDBY_deltalin'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='1_SHIFTEDBY_deltalin',  ## match to deltaZ
                    save_bestfit_field=
                    'hat_deltaZ_T_delta12G23_SHIFTEDBY_deltalin'))
    ...
    if False:
        ...
        for target in ['delta_m']:
            if False:
                ...
                opts['trf_specs'].append(
                    TrfSpec(linear_sources=['delta_h'],
                            field_to_smoothen_and_square='delta_h',
                            quadratic_sources=['growth', 'tidal_G2'],
                            target_field=target,
                            save_bestfit_field='hat_%s_from_b1b2bG2_delta_h' %
                            target))
            ...
            if False:
                ...
                opts['trf_specs'].append(
                    TrfSpec(linear_sources=['delta_h'],
                            ...
                            quadratic_sources=[],
                            target_field=target,
                            save_bestfit_field='hat_%s_from_b1_delta_h_M0' %
                            target))
            ...
            if False:
                ...
                opts['trf_specs'].append(
                    TrfSpec(linear_sources=['delta_h_WEIGHT_M1'],
                            field_to_smoothen_and_square=None,
                            quadratic_sources=[],
                            target_field=target,
                            save_bestfit_field='hat_%s_from_b1_delta_h_M1' %
                            target))
            ...
            if True:
                ...
                # delta_h^{M^n} is mass-weighted halo density weighted by M^n, using exact mass.
                opts['trf_specs'].append(
                    TrfSpec(linear_sources=['delta_h', 'delta_h_WEIGHT_M1'],
                            field_to_smoothen_and_square=None,
                            quadratic_sources=[],
                            target_field=target,
                            save_bestfit_field='hat_%s_from_b1_delta_h_M0_M1' %
                            target))
            ...
            if False:
                ...
                opts['trf_specs'].append(
                    TrfSpec(
                        linear_sources=[
                            'delta_h', 'delta_h_WEIGHT_M1', 'delta_h_WEIGHT_M2'
                        ],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field=target,
                        export_bestfit_field=True,
                        save_bestfit_field='hat_%s_from_b1_delta_h_M0_M1_M2' %
                        target))
                ...
                for myscatter in ['0.1dex', '0.2dex', '0.4dex']:
                    opts['trf_specs'].append(
                        TrfSpec(
                            linear_sources=[
                                'delta_h',
                                'delta_h_WEIGHT_M%s' % myscatter
                            ],
                            field_to_smoothen_and_square=None,
                            quadratic_sources=[],
                            target_field=target,
                            save_bestfit_field='hat_%s_from_b1_delta_h_M0_M%s' %
                            (target, myscatter)))
            ...
            if False:
                ...
                opts['trf_specs'].append(
                    TrfSpec(
                        ...
                        target_field=target,
                        save_bestfit_field=
                        'hat_%s_from_b1_delta_h_Mbins11.8_12.8_13.8_14.8_16.0' %
                        target))
    ...
    for target in ['delta_h']:
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['deltaZA'],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field=target,
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['delta_m'],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field=target,
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['deltalin'],
                        ...
                        quadratic_sources=['F2', 'growth', 'tidal_G2'],
                        sources_for_trf_fcn=[
                            'deltalin+deltalin_F2', 'deltalin_growth',
                            'deltalin_tidal_G2'
                        ],
                        target_field=target,
        ...
        if False:  #if True:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=['deltalin', 'deltaZA'],
                    field_to_smoothen_and_square='deltalin',
                    quadratic_sources=['growth', 'tidal_G2'],
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['deltalin', 'deltaZA'],
                        field_to_smoothen_and_square='deltalin',
                        quadratic_sources=['growth', 'F2', 'tidal_G2'],
                        target_field=target,
                        save_bestfit_field=
                        'hat_delta_h_from_deltalin_deltaZ_deltalin2F2G2'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['deltaZA'],
                        ...
                        target_field=target,
                        save_bestfit_field=
                        'hat_delta_h_from_deltaZ_deltaZ2G2_deltaZ2G2'))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field=target,
                    save_bestfit_field=
                    'hat_delta_h_from_b1_b2_bG2_deltalin_shifted'))

        if False:
            #if False:
            # Linear Lagrangian bias: delta_Z + b1 deltalin(q+Psi)
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['deltalin_SHIFTEDBY_deltalin'],
                        fixed_linear_sources=['1_SHIFTEDBY_deltalin'],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field=target,
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=[
                    ...
                    'deltalin_G2_SHIFTEDBY_deltalin'
                        ...
                        target_field=target,
                        save_bestfit_field=
                        'hat_delta_h_from_T1_Tdeltalin2G2_SHIFTEDBY_PsiZ'))
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=[
                    ...
                    'deltalin_G2_SHIFTEDBY_Psi2LPT_deltalin'
                        ...
                        target_field=target,
                        save_bestfit_field=
                        'hat_delta_h_from_T1_Tdeltalin2G2_SHIFTEDBY_Psi2LPT'))

        if False:
            # Test 2 codes that generate delta_Z (main_ms_gadget_shift.. vs Genic: got rcc=1 and same P(k) so fine)
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['1_SHIFTEDBY_deltalin', 'deltaZA'],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field=target,
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(linear_sources=['1_SHIFTEDBY_deltalin'],
                        field_to_smoothen_and_square=None,
                        quadratic_sources=[],
                        target_field='delta_m',
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=['1_SHIFTEDBY_Psi2LPT_deltalin'],
                    field_to_smoothen_and_square=None,
                    quadratic_sources=[],
                    target_field='delta_m',
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=['1_SHIFTEDBY_-Psi2LPT_deltalin'],
                    field_to_smoothen_and_square=None,
                    quadratic_sources=[],
                    target_field='delta_m',
    ...
    if False:
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    save_bestfit_field=
                    'hat_deltaZA_from_T_delta_h_M0_M1_Tdeltalin2G23_nob1_SHIFTEDBY_PsiZ'
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='deltaZA',
                    save_bestfit_field=
                    'hat_deltaZA_from_T_delta_h_M0_M1_Tdeltalin2G23_withb1_SHIFTEDBY_PsiZ'
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    linear_sources=[
                        'delta_h', 'delta_h_WEIGHT_M1',
                        'deltalin_SHIFTEDBY_deltalin',
                        'deltalin_growth-mean_SHIFTEDBY_deltalin',
                        'deltalin_G2_SHIFTEDBY_deltalin',
                        'deltalin_cube-mean_SHIFTEDBY_deltalin'
                    ],  # all possible linear sources to load
                    non_orth_linear_sources=[
                        '[delta_h_WEIGHT_M1]_MINUS_[delta_h]'
                    ],  # sources with trf fcns that are not included in orthogonalization
                    sources_for_trf_fcn=[
                        'deltalin_SHIFTEDBY_deltalin',
                        'deltalin_growth-mean_SHIFTEDBY_deltalin',
                        'deltalin_G2_SHIFTEDBY_deltalin',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_from_T_delta_M1_MINUS_delta_h_1_T_orth_deltalin12G23_SHIFTEDBY_PsiZ'
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field='delta_h',
                    save_bestfit_field=
                    'hat_delta_h_from_T_delta_M1_MINUS_delta_h_T_orth_deltalin12G23_SHIFTEDBY_PsiZ'
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    fixed_linear_sources=[
                        '1_SHIFTEDBY_deltalin'
                    ],  # if target_spec!=None, using this gives slightly sub-optimal target weights
                    field_to_smoothen_and_square=None,
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M1M0_for_1_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        ...
                        save_bestfit_target_field=
                        'BEST_MSE_delta_h_M1M0_for_1_deltalin12G23_SHIFTEDBY_PsiZ'
                        # where to save bestfit combi of targets
                    ),
                    save_bestfit_field=
                    'hat_delta_h_M1M0_MSE_noZ_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M1M0_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h_WEIGHT_M1', 'delta_h'],
                        minimization_objective=
                        '(target0+T*other_targets-T*sources)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_MSE_noZ_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M0M1_for_1_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_MSE_noZ_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M0M1_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(target0+T*other_targets-T*sources)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_MSE_noZ_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
            ...
            for myscatter in ['0.4dex', '0.2dex', '0.1dex']:
                opts['trf_specs'].append(
                    TrfSpec(
                        ...
                        quadratic_sources=[],
                        target_field=
                        'BEST_MSE_delta_h_M0M%s_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ'
                        % myscatter,
                        target_spec=TargetSpec(
                            linear_target_contris=[
                                'delta_h',
                                'delta_h_WEIGHT_M%s' % myscatter
                            ],
                            minimization_objective=
        ...
        if True:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M0M1_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(target0+T*other_targets-T*sources)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_MSE_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_MSE_delta_h_M1M0_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h_WEIGHT_M1', 'delta_h'],
                        minimization_objective=
                        '(target0+T*other_targets-T*sources)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_MSE_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    fixed_linear_sources=
                    [],  # must be [] if minimization_objective='(T*data-T*model)^2/(T*data)^2'
                    field_to_smoothen_and_square=None,
                    quadratic_sources=[],
                    target_field=
                    'BEST_delta_h_M0M1_for_1deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_from_T_1deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_delta_h_M0M1_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_spec=TargetSpec(
                        ...
                        target_norm={'type': 'alpha0=1'},
                        save_bestfit_target_field=
                        'BEST_delta_h_M0M1_for_b1_delta_m'
                        # where to save bestfit combi of targets
                    ),
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_from_b1_delta_m'  # where to save bestfit combi of sources
                ))
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_spec=TargetSpec(
                        ...
                        target_norm={'type': 'alpha0=1'},
                        save_bestfit_target_field=
                        'BEST_delta_h_M0M1_for_b12G2_delta_m'
                        # where to save bestfit combi of targets
                    ),
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_from_b12G2_delta_m'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    quadratic_sources=[],
                    target_field=
                    'BEST_delta_h_M0M1_for_deltalin1_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_from_T_1deltalin1_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_from_T_1deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    target_field=
                    'BEST_delta_h_M0M1_MPZZ_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_MPZZ_from_T_1deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    # 'MPZZ' stands for match power to Zeldovich-Zeldovich power spectrum.
                    target_field=
                    'BEST_delta_h_M1M0_MPZZ_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h_WEIGHT_M1', 'delta_h'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_noZ_MPZZ_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_noZ_MPZZ_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    # 'MPZZ' stands for match power to Zeldovich-Zeldovich power spectrum.
                    target_field=
                    'BEST_delta_h_M1M0_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h_WEIGHT_M1', 'delta_h'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_noZ_MPnn_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
            ...
            for myscatter in ['0.4dex', '0.2dex', '0.1dex']:
                opts['trf_specs'].append(
                    TrfSpec(
                        ...
                        # 'MPZZ' stands for match power to Zeldovich-Zeldovich power spectrum.
                        target_field=
                        'BEST_delta_h_M%sM0_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ'
                        % myscatter,
                        target_spec=TargetSpec(
                            linear_target_contris=[
                                'delta_h_WEIGHT_M%s' % myscatter, 'delta_h'
                            ],
                            minimization_objective=
                            '(T*target-T*sources)^2/(T*target)^2',
                            target_norm={
                        ...
                        save_bestfit_field=
                        'hat_delta_h_M%sM0_noZ_MPnn_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'
                        % myscatter  # where to save bestfit combi of sources
                    ))
            ...
            for myscatter in ['0.4dex', '0.2dex', '0.1dex']:
                opts['trf_specs'].append(
                    TrfSpec(
                        ...
                        # 'MPZZ' stands for match power to Zeldovich-Zeldovich power spectrum.
                        target_field=
                        'BEST_delta_h_M0M%s_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ'
                        % myscatter,
                        target_spec=TargetSpec(
                            linear_target_contris=[
                                'delta_h',
                        ...
                        save_bestfit_field=
                        'hat_delta_h_M0M%s_noZ_MPnn_from_1_T_deltalin12G23_SHIFTEDBY_PsiZ'
                        % myscatter  # where to save bestfit combi of sources
                    ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    # 'MPZZ' stands for match power to Zeldovich-Zeldovich power spectrum.
                    target_field=
                    'BEST_delta_h_M0M1_MPnn_for_deltalin12G23_SHIFTEDBY_PsiZ',
                    target_spec=TargetSpec(
                        linear_target_contris=['delta_h', 'delta_h_WEIGHT_M1'],
                        minimization_objective=
                        '(T*target-T*sources)^2/(T*target)^2',
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M0M1_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
        ...
        if False:
            ...
            opts['trf_specs'].append(
                TrfSpec(
                    ...
                    save_bestfit_field=
                    'hat_delta_h_M1M0_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'  # where to save bestfit combi of sources
                ))
    ...
    if opts['sim_name'] in ['jerryou_baoshift', 'ms_gadget']:
        ...
        opts['cosmo_params'] = dict(Om_m=0.292,
                                    Om_L=1.0 - 0.292,
                                    Om_K=0.0,
                                    Om_r=0.0,
                                    h0=0.69)
