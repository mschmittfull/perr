...
def get_pickle_fname():
    ...
    fname = 'main_calc_mom_Perr_2019_Mar_15_19/33/08_time1552678388.pickle';  plot_opts.update({'ymin_1mr2': 0.00005, 'ymin_Tk': -1, 'ymax_Tk': 2, 'tryid': 'L32cNoZ', 'pickle_fname_DM_model_error': 'main_do_stage012_rec_2018_Jul_10_15:15:54_time1531235754.pickle'});  math_id='tryL32cNoZ_M10.8-11.8';  # M=10.8-11.8
