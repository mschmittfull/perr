...
def main():
    ...
    if False:
        trf_fcn_fitspecs.append({
            ...
            'settings': {'kmin': 0.01, 'kmax': 0.2, 'exponents': [0,2,4]}
            })
    if False:
        trf_fcn_fitspecs.append({
            'name': 'const + const k^2 + const k^4 high kmax',
            'type': 'constrained_polyfit', 
            'settings': {'kmin': 0.01, 'kmax': 0.8, 'exponents': [0,2,4]}
            })
    ...
    if False:
        ...
        trf_fcn_fitspecs.append({
            ...
            'settings': {
                ...
                'kmin': 0.01, 'kmax': 2.0, 'color': 'grey',
                'bestfit_params': {
                    ('10.8','11.8'): {'b1': -0.120745, 'cs': 0.0697826, 'bGamma3': 0.282946, 'b2': -0.183017, 'bG2': -0.211043, 'b3': 0.00233065},
                    ('11.8','12.8'): {'b1': 0.0513072, 'cs': 0.277575, 'bGamma3': 0.236465, 'b2': -0.323, 'bG2': -0.183022, 'b3': -0.0844928},
                    ('12.8','13.8'): {'b1': 0.677678, 'cs': 1.36496, 'bGamma3': -0.0132997, 'b2': -0.215479, 'bG2': -0.0301784, 'b3': -0.386499},
                    ('13.8','15.1'): {'b1': 2.49556, 'cs': 3.45788, 'bGamma3': 1.0264, 'b2': 1.89056, 'bG2': -1.20618, 'b3': 0.649821}
                    }}
                    })
    ...
    if False:
        ...
        trf_fcn_fitspecs.append({
            ...
            'settings': {
                'tf_fname': 'from_marko_and_val/fit_b1_16may2018/TF.txt',
                'kmin': 0.01, 'kmax': 2.0, 'color': 'k',
                'bestfit_params': {
                    ('10.8','11.8'): {'b1': -0.120705, 'cs': -0.0378647, 'bGamma3': 0.274557, 'b2': -0.18441, 'bG2': -0.209507, 'b3': 0.00233065},
                    ('11.8','12.8'): {'b1': 0.0540231, 'cs': 0.378935, 'bGamma3': 0.243066, 'b2': -0.328223, 'bG2': -0.157525, 'b3': -0.0844928},
                    ('12.8','13.8'): {'b1': 0.705413, 'cs': 3.79773, 'bGamma3': 0.288405, 'b2': -0.250961, 'bG2': 0.0964298, 'b3': -0.386499},
                    ('13.8','15.1'): {'b1': 2.45389, 'cs': 0.429736, 'bGamma3': 0.10803, 'b2': 1.82867, 'bG2': -1.02188, 'b3': 0.649821}
                    }}
                    })
        ...
        if False:
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'k',
                    'bestfit_params': {
                        ('10.8','11.8'): dict(b1 = -0.121, cs = -0.165, bGamma3 = 0.263, b2 = -0.181, bG2 = -0.212, b3 = 0.0023),
                        ('11.8','12.8'): dict(b1 = 0.054, cs = 0.482, bGamma3 = 0.255, b2 = -0.326, bG2 = -0.162, b3 = -0.0845),
                        ('12.8','13.8'): dict(b1 = 0.701, cs = 3.491, bGamma3 = 0.230, b2 = -0.237, bG2 = 0.069, b3 = -0.386),
                        ('13.8','15.1'): dict(b1 = 2.456, cs = -0.341, bGamma3 = 0.0546, b2 = 1.841, bG2 = -0.961, b3 = 0.650)
                        }}
                        })
        if False:
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'k',
                    'bestfit_params': {
                        ('10.8','11.8'): dict(b1 = 0.882, cs = 0.0115, bGamma3 = 0.595, b2 = -0.226, bG2 = 0.291, b3 = 0.0029),
                        ('11.8','12.8'): dict(b1 = 1.057, cs = 0.648, bGamma3 = 0.571, b2 = -0.384, bG2 = 0.340, b3 = -0.084),
                        ('12.8','13.8'): dict(b1 = 1.703, cs = 3.678, bGamma3 = 0.532, b2 = -0.307, bG2 = 0.567, b3 = -0.388),
                        ('13.8','15.1'): dict(b1 = 3.457, cs = -0.143, bGamma3 = 0.321, b2 = 1.758, bG2 = -0.455, b3 = 0.656),
                        }}
                        })
        ...
        if False:
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'k',
                    'bestfit_params': {
                        ('10.8','16.0'): dict(b1 = 0.924, cs = -1.354, bGamma3 = 0.619, b2 = -0.00616, bG2 = 0.139, b3 = -0.00164),
                        ('11.8','16.0'): dict(b1 = 1.149, cs = -1.347, bGamma3 = 0.618, b2 = 0.062, bG2 = 0.124, b3 = -0.00736),
                        ('12.8','16.0'): dict(b1 = 1.817, cs = 0.981, bGamma3 = 0.978, b2 = 0.411, bG2 = 0.0392, b3 = 0.0473),
                        ('13.8','16.0'): dict(b1 = 3.485, cs = -1.495, bGamma3 = 1.307, b2 = 2.322, bG2 = -1.427, b3 = 1.329),
                        }}
                        })
        ...
        if False:
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'grey',
                    'bestfit_params': {
                        ('10.8','11.8'): dict(b1 = -0.12, cs = 0.0587, bGamma3 = 0.302, b2 = -0.178, bG2 = -0.221, b3 = 0.0023),
                        ('11.8','12.8'): dict(b1 = 0.0508, cs = 0.23, bGamma3 = 0.26, b2 = -0.314, bG2 = -0.205, b3 = -0.0845),
                        ('12.8','13.8'): dict(b1 = 0.674, cs = 1.205, bGamma3 = 0.061, b2 = -0.19, bG2 = -0.112, b3 = -0.386),
                        ('13.8','15.1'): dict(b1 = 2.472, cs = 3.017, bGamma3 = 1.165, b2 = 1.982, bG2 = -1.407, b3 = 0.650),
                        }}
                        })
        if True:
            # New transfer functions without \delta_Z fitted to tryL32cNoZ
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'grey',
                    'bestfit_params': {
                        ('10.8','11.8'): dict(b1 = 0.878, cs = 0.0778, bGamma3 = 0.59, b2 = -0.222, bG2 = 0.274, b3 = 0.0029),
                        ('11.8','12.8'): dict(b1 = 1.05, cs = 0.249, bGamma3 = 0.568, b2 = -0.366, bG2 = 0.269, b3 = -0.084),
                        ('12.8','13.8'): dict(b1 = 1.672, cs = 1.223, bGamma3 = 0.345, b2 = -0.254, bG2 = 0.36, b3 = -0.388),
                        ('13.8','15.1'): dict(b1 = 3.468, cs = 3.035, bGamma3 = 1.401, b2 = 1.905, bG2 = -0.922, b3 = 0.656),
                        }}
                        })
        ...
        if False:
            ...
            trf_fcn_fitspecs.append({
                ...
                'settings': {
                    ...
                    'kmin': 0.01, 'kmax': 2.0, 'color': 'grey',
                    'bestfit_params': {
                        ('10.8','16.0'): dict(b1 = 0.943, cs = -0.0798, bGamma3 = 0.826, b2 = -0.0177, bG2 = 0.162, b3 = -0.00164),
                        ('11.8','16.0'): dict(b1 = 1.162, cs  = 0.136, bGamma3 = 0.852, b2 = 0.063, bG2 = 0.123, b3 = -0.00736),
                        ('12.8','16.0'): dict(b1 = 1.811, cs = 1.056, bGamma3 = 1.175, b2 = 0.441, bG2 = -0.137, b3 = 0.0473), # (Marko: a very bad fit)
                        ('13.8','16.0'): dict(b1 = 3.499, cs = 2.125, bGamma3 = 2.342, b2 = 2.426, bG2 = -1.847, b3 = 1.329),
                        }}
                        })
    ...
    for target_id in ['delta_m','deltaZA']:
        ...
        'hat_delta_h_from_b1_delta_m': {'color': constants.purples4[-1], 'lw': 2},
        'hat_delta_h_from_1_Tdeltalin_SHIFTEDBY_PsiZ': {'color': constants.oranges[-2],'lw':2},
        'hat_delta_h_from_1_Tdeltalin2G2_SHIFTEDBY_PsiZ': {'color': constants.oranges[-3]},
        'hat_delta_h_from_1_Tdeltalin2G23_SHIFTEDBY_PsiZ': {'color': constants.oranges[-5]},
        'hat_delta_h_from_Tdeltalin_SHIFTEDBY_PsiZ': {'color': constants.oranges[-2],'lw':2},
        'hat_delta_h_from_Tdeltalin2G2_SHIFTEDBY_PsiZ': {'color': constants.oranges[-3], 'lw': 3},
        'hat_delta_h_from_Tdeltalin2G23_SHIFTEDBY_PsiZ': {'color': constants.oranges[-5], 'lw': 2},
        'hat_%s_from_b1_delta_h_M0'%target_id: {'ls': '--', 'color': 'grey','lw':1},
        'hat_%s_from_b1_delta_h_M1'%target_id: {'ls': ':', 'color': 'grey','lw':1},
        'hat_%s_from_b1_delta_h_M0_M1'%target_id: {'ls': '-', 'color': 'k'},
        'hat_%s_from_b1_delta_h_M0_M0.04dex'%target_id: {'ls': '-', 'color': constants.oranges[-1-0]},
        'hat_%s_from_b1_delta_h_M0_M0.1dex'%target_id: {'ls': '-', 'color': constants.oranges[-1-1]},
        'hat_%s_from_b1_delta_h_M0_M0.3dex'%target_id: {'ls': '-', 'color': constants.oranges[-1-2]},
        'hat_%s_from_b1_delta_h_M0_M0.6dex'%target_id: {'ls': '-', 'color': constants.oranges[-1-3]},
        'hat_delta_h_from_deltanonl_12G2': {'color': constants.purples4[-2]},
        'hat_delta_h_one_loop_deltaSPT': {'color': constants.oranges[-1]},
        'hat_delta_h_from_delta_m_deltalin2_deltalinG2': {'color': constants.oranges[-2]}
        })
    # mass-weighted halos with scatter
    if True:
        if mass_weighted:
            manual_plot_kwargs['hat_delta_h_from_Tdeltalin2G23_SHIFTEDBY_PsiZ'] = {
                'ls': '-', 'lw': 3, 'color': 'darkgreen', 'label': 'No mass weights'}
            #'ls': '-', 'color': 'dimgrey', 'label': 'No mass weighting'}
        for i, myscatter in enumerate(['0.4dex','0.2dex','0.1dex']):
            manual_plot_kwargs['hat_delta_h_M0M%s_MSE_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'%myscatter] = {
                'ls': '-', 'color': constants.greens4[-1-i], 'label': '$\\sigma_M=$%s'%myscatter,
                'lw': 3}
        manual_plot_kwargs['hat_delta_h_M0M1_MSE_noZ_MPnn_from_T_deltalin12G23_SHIFTEDBY_PsiZ'] = {
                'ls': '-', 'color': 'lightgrey', 'label': '$\\sigma_M=0$', 'lw': 3}
        manual_plot_kwargs['hat_delta_m_from_1_Tdeltalin2G23_SHIFTEDBY_PsiZ'] = {
            'color': 'grey', 'ls':(0,[9,2,2,2]), 'lw': 1, 'label': 'Theory limit', 'zorder':0, 'alpha': 0.9}
        #'ls': (0, [6,3]),
    ...
    if True:
        ...
        if layout == '4x1':
            fig, axarr = plt.subplots(4,1,figsize=(8,12), sharex=True, sharey=False); axorder = [0,1,2,3]
        elif layout == '2x2':
            fig, axarr = plt.subplots(2,2,figsize=(12,10), sharex=False, sharey=False); axorder = [(0,0),(0,1),(1,0),(1,1)]
        # loop over mass bins
        for iM in range(len(halo_masses)):
            log10M_min, log10M_max = halo_masses[iM]
            halo_mass_string = halo_mass_strings[iM]
            vpkey = ( (('halo_mass_string', ), 
                       halo_mass_string) ,)
            ...
            for tfcounter, tf in enumerate(trf_specs[:1]):
                for icounter, Rsmooth in enumerate(Rsmooth_lst[:1]):
                    tmp_key = stacked_pickles[(Rsmooth,)]['Pkmeas'].keys()[0]
                    kvec = np.mean(stacked_pickles[(Rsmooth,)]['Pkmeas'][tmp_key]['k'], axis=0)

            # CIC window (eq. 21 from jing et al https://arxiv.org/pdf/astro-ph/0409240.pdf)
            Delta_x=base_pickle_opts['sim_boxsize']/float(base_pickle_opts['Ngrid'])
            k_nyq=np.pi/Delta_x
            nbar_kvec = np.zeros(kvec.shape[0]+1)
            nbar_kvec[0] = kmin_plot
            nbar_kvec[1:] = kvec
            Pk_CIC = 1.0 - 2./3.*( np.sin(np.pi*nbar_kvec/(2.0*k_nyq)) )**2
            eval_Pk_CIC_at_kvec = lambda mykvec: 1.0 - 2./3.*( np.sin(np.pi*mykvec/(2.0*k_nyq)) )**2
            ...
            # #################################################################################
            if trf_fcn_fitspecs != []:
                fitted_stacked_pickles = fit_trf_fcns.do_fit_trf_fcns(stacked_pickles=stacked_pickles,
            ...
            if nbar_of_cat.has_key('delta_h'):
                ...
                ax.plot(nbar_kvec,
                        ...
                        color='k', ls='-', lw=3, zorder=0, alpha=0.9,
                        label=label)
            ...
            for tfcounter, tf in enumerate(trf_specs):
                ...
                if tf.save_bestfit_field in ['hat_delta_h_from_1_Tdeltalin2G23_SHIFTEDBY_PsiZ',
                ...
                for icounter_R, Rsmooth in enumerate(Rsmooth_lst):
                    ...
                    label = '%s' % get_texlabel(
                        tf.save_bestfit_field, include_data_label=include_data_label,
                    ...
                    if True:
                        ...
                        if Pks.has_key((residual_key,residual_key)):
                            ymat = Pks[(residual_key,residual_key)]['P']/my_one_over_nbar
                            ...
                            if True:
                                ...
                                if tfcounter == 0:
                                    ...
                                    label='_nolabel_'
                                ax.semilogx(kvec, np.mean(ymat,axis=0),
                                            ls=plt_kwargs['ls'], color='k', lw=1, alpha=0.8, 
                                            label=label)
                            if False:
                                # plot errorbar
                                plt_kwargs['marker'] = '.'
                                ax.errorbar(kvec, np.mean(ymat,axis=0),
                            ...
                            if True:
                                ...
                                if ymax_plot2 is not None:
                                    myones = np.ones(yerr.shape) * ymax_plot2/tmp_height * 2
                                else:
                                    myones = np.ones(yerr.shape) * 0.02
                                myerr = np.maximum(yerr, myones)
                                ax.fill_between(kvec, 
                                                (np.mean(ymat,axis=0)-myerr),
                                                (np.mean(ymat,axis=0)+myerr),
                                                facecolor=col, lw=0, alpha=0.9, #alpha=0.6,
                                                label=mylabel)
                                if (not show_legend) and False:
                                    # draw invisible lines and annotate them later
                                    ax.plot(kvec,(np.mean(ymat,axis=0)+yerr+0.3),alpha=0, label=label)
                    ...
                    for ifit, fitspec in enumerate(trf_fcn_fitspecs):
                        ...
                        if True:
                            ...
                            ax.loglog(kvec[ww], np.mean(ymat,axis=0)[ww],
                                      color='k',#col, 
                                      lw=2, alpha=1, #alpha=0.6, #+ifit*0.2,
                                      ls='--', label='_nolabel_')
                            #label='Fitted %s' % label)
                            if False:
                                # print
                                if len(np.where(~np.isnan(np.mean(ymat,axis=0)[ww]))[0])>0:
                                    print("plotted k:", kvec[ww])
                                    print("plotted noise:", np.mean(ymat,axis=0)[ww])
                                    raise Exception("hello")
                        else:
                            # with errorbar
                            ax.errorbar(kvec[ww], np.mean(ymat,axis=0)[ww],
                                      yerr=np.std(ymat,axis=0)/np.sqrt(float(Nsims-1)),
                                      color=col, lw=1,
                                      ls=linestyles[tfcounter], label='Fitted %s' % label)
                    if iM == 0 and tryid=='L32cNoZ':
                        mykvec,myyvec = get_manual_noise_over_poisson_curve_low_Mbin_with_Z(ax)
            ...
            if layout == '4x1':
                if iM==len(halo_masses)-1:
                    ax.set_xlabel('$k\;[h\\mathrm{Mpc}^{-1}]$',fontsize=constants.xylabelfs)
            elif layout == '2x2':
                if axorder[iM][0] == 1:
                    ax.set_xlabel('$k\;[h\\mathrm{Mpc}^{-1}]$',fontsize=constants.xylabelfs)
                if iM in [0,1]:
            ...
            if False:
                ax.set_ylabel('$($Model error$)^2$/Poisson prediction', fontsize=constants.xylabelfs)
            # make space for ylabel
            if iM==2:
                ax.set_ylabel('tmp', color='w', fontsize=constants.xylabelfs, labelpad=20)
            ...
            if True:
                ...
                for icounter, Rsmooth in enumerate(Rsmooth_lst):
                    ...
                    if tf.target_field=='delta_h':
                        ...
                        label = 'P_{%s%s}' % (get_texlabel(tf.target_field),get_texlabel(tf.target_field))
                    if False:
                        # include errorbar
                        ax.errorbar(kvec, np.mean(ymat,axis=0)/my_one_over_nbar,
                                    yerr=np.std(ymat,axis=0)/np.sqrt(float(Nsims-1))/my_one_over_nbar,
                                    lw=2,
                                    color='grey',
                                    ls=':', label=label)
                    else:
                        # no errorbar
                        ax.plot(kvec, np.mean(ymat,axis=0)/my_one_over_nbar,
                                  lw=2,
                                  color='grey', 
                                  ls=':', label=label)      
            ...
            if False:
                ...
                if ('deltaZA','deltalin') in Pks.keys():
                    ymat = Pks[('deltaZA','deltaZA')]['P'] - 2.0 * Pks[('deltaZA','deltalin')]['P'] + Pks[('deltalin','deltalin')]['P']
                    ax.errorbar(kvec, 1.2+0.05*np.mean(ymat,axis=0)/my_one_over_nbar, 
                                yerr=np.std(ymat,axis=0)/np.sqrt(float(Nsims-1))/my_one_over_nbar,
                                color='grey', ls='-', lw=1, label='$\\propto$ Power of $(\\delta_Z-\\delta_1)$')
            ...
            if plot_opts.get('AllEulerianBiases', False):
                ...
                interp_P22 = interp.interp1d(P22[:,0], P22[:,1], kind='linear', bounds_error=False,
                                             fill_value=(P22[0,1], P22[-1,1]))

                # M=10.8-11.8, bumpino
                ax.plot(kvec, (1.2+0.025*interp_P22(kvec)/my_one_over_nbar)*eval_Pk_CIC_at_kvec(kvec), 'k--', 
                        lw=1.5, alpha=0.9,
                ...
                if False:
                    ...
                    ax.plot(kvec, 
                            ((np.minimum(1.1+0.1*interp_P22(kvec)/my_one_over_nbar, Ptarget/my_one_over_nbar))
                            *eval_Pk_CIC_at_kvec(kvec)),
                            'k--', label='$\\propto P_{22}$')
            ...
            # title
            if True:
                make_title(plot_title, log10M_min, log10M_max, my_one_over_nbar, redshift, ytitle=ytitle_arr[iM])
            if iM==0:
                plt.title('tmp', color='w', fontsize=constants.xylabelfs-4) # just to pad space
                #plt.title('FOF halos at $\\,z=$%.1f, no mass weighting' % redshift, y=1.01, fontsize=constants.xylabelfs-4)
            # legend
            if show_legend:
                if len(Rsmooth_lst)>1:
                    ax.legend(loc='best',ncol=2,fontsize=8,frameon=False,handlelength=4)
                else:
                    if not mass_weighted:
                        # no mass weighting
                        if plot_opts.get('AllEulerianBiases', False):
                            # special for tryO17:
                            legend = ax.legend(loc='best',ncol=1,fontsize=constants.xylabelfs-6,frameon=True,handlelength=1.5,
                                      labelspacing=0.3, framealpha=0.7, fancybox=True)
                            legend.get_frame().set_linewidth(1)
                        else:
                            ax.legend(loc='best',ncol=2,fontsize=constants.xylabelfs-6,frameon=False,handlelength=1.5)            
                    else:
                        # with mass weighting
                        ax.legend(loc='upper left',ncol=2,fontsize=constants.xylabelfs-4,
            ...
            if show_annotation:
                ...
                if layout == '4x1':
                    if ( (not (log10M_min is None or log10M_max is None))
                          and np.isclose(float(log10M_min), 10.8) and np.isclose(float(log10M_max), 11.8)):
                        # annotate lines by hand
                        #ax.text(0.0175, 165, 'Linear Eulerian bias', fontsize=constants.xylabelfs-2)
                        ax.text(0.13, 5.25, 'Linear Eul. bias', fontsize=constants.xylabelfs-2, rotation=-18)
                        ax.text(0.1, 3.5, 'Linear Lagr. bias', fontsize=constants.xylabelfs-2, rotation=-12)
                        ax.text(0.02, 1.75, 'Quadratic Lagr. bias', fontsize=constants.xylabelfs-2, rotation=0)
                        ...
                        #ax.text(0.6, 3., '$P_{hh}$', fontsize=constants.xylabelfs-2, color='grey', rotation=0)
                          ...
                          and np.isclose(float(log10M_min), 11.8) and np.isclose(float(log10M_max), 12.8)):
                        # annotate lines by hand
                        ...
                        ax.text(0.55, 2.5, '$P_{hh}$', fontsize=constants.xylabelfs-2, color='grey', rotation=0)
                    elif ( (not (log10M_min is None or log10M_max is None))
                          and np.isclose(float(log10M_min), 12.8) and np.isclose(float(log10M_max), 13.8)):
                        # annotate lines by hand
                        ax.text(0.04, 1.2, 'Poisson prediction', fontsize=constants.xylabelfs-2, rotation=0)
                        ax.text(0.025, 0.4, 'Partial cubic Lagr. bias', fontsize=constants.xylabelfs-2, rotation=0)
                elif layout == '2x2':
                    if ( (not (log10M_min is None or log10M_max is None))
                          and np.isclose(float(log10M_min), 10.8) and np.isclose(float(log10M_max), 11.8)):
                        # annotate lines by hand
                        #ax.text(0.0175, 165, 'Linear Eulerian bias', fontsize=constants.xylabelfs-2)
                        ax.text(0.13, 5.25, 'Linear Std. Eul. bias', fontsize=constants.xylabelfs-2, rotation=-34)
                        ax.text(0.09, 3.6, 'Linear bias', fontsize=constants.xylabelfs-2, rotation=-25)
                        ax.text(0.015, 2.1, 'Quadr. bias', fontsize=constants.xylabelfs-2, rotation=0)
                        #ax.text(0.02, 0.25, 'Poisson prediction', fontsize=constants.xylabelfs-2, rotation=0)
                        #ax.text(0.6, 3., '$P_{hh}$', fontsize=constants.xylabelfs-2, color='grey', rotation=0)
                    elif ( (not (log10M_min is None or log10M_max is None))
                          and np.isclose(float(log10M_min), 11.8) and np.isclose(float(log10M_max), 12.8)):
                        ...
                        ax.text(0.55, 2.5, '$P_{hh}$', fontsize=constants.xylabelfs-2, color='grey', rotation=0)
                          ...
                          and np.isclose(float(log10M_min), 12.8) and np.isclose(float(log10M_max), 13.8)):
                        # annotate lines by hand
                        ax.text(0.06, 1.06, 'Poisson prediction', fontsize=constants.xylabelfs-2, rotation=0)
                        ax.text(0.025, 0.45, 'Cubic bias', fontsize=constants.xylabelfs-2, rotation=0)
        ...
        fig.text(0.06, 0.5, '$P_\\mathrm{err}\\;/$ Poisson prediction',
                 fontsize=constants.xylabelfs,
                 ha='center', va='center', rotation='vertical')
        fig.text(0.5, 0.96, 'FOF halos at $\\,z=$%.1f, no mass weighting' % redshift,
    ...
    if False:
        ...
        ## PLOT
        fig, axarr = plt.subplots(5,2,figsize=(12,13), sharex=False, sharey=False,
        ...
        linestyles = [(10, [14,4,2,4]), (0, [12,6]),  (0, [8,4]), (0, [3,3]), (0, [1,1])]
        # loop over panels
        for iM in range(len(halo_masses)):
            log10M_min, log10M_max = halo_masses[iM]
            halo_mass_string = halo_mass_strings[iM]
            ...
            for plt_type in ['1mr2', 'r']:
                ...
                for tfcounter, tf in enumerate(trf_specs):
                    for icounter, Rsmooth in enumerate(Rsmooth_lst):
                        ...
                        if plt_type == 'r':
                            ymat = Pks[(id1,id2)]['P']/np.sqrt(Pks[(id1,id1)]['P']*Pks[(id2,id2)]['P'])
                        elif plt_type == '1mr2':
                            ymat = 1.0 - Pks[(id1,id2)]['P']**2/(Pks[(id1,id1)]['P']*Pks[(id2,id2)]['P'])
                        else:
                            raise Exception("Invalid plt_type %s" % str(plt_type))
                        if len(Rsmooth_lst)>1:
                            label = '%s, $R=$%g' % (
                                get_texlabel(tf.save_bestfit_field,include_data_label=include_data_label),Rsmooth)
                        ...
                        if True:
                            # no errorbar
                            if mass_weighted:                        
                                plt_kwargs.update({'color': col, 'alpha': 1,
                                                   'marker': '', 'zorder': 1+tfcounter, 'label': label})
                            else:

                                plt_kwargs = {'ls': linestyles[tfcounter], 'label': label,
                                              'lw': lw, 'alpha': 0.9, 'color': col,
                                              'marker': '', 'zorder': 1+tfcounter}
                        ...
                        if False:
                            ...
                            ax.errorbar(kvec, np.mean(ymat,axis=0),
                                        yerr=np.std(ymat,axis=0)/np.sqrt(float(Nsims-1)),
                                        color=col,
                                        ls=linestyles[tfcounter], label=label)
                        if False:
                            # plot errors using fill_between
                            yerr = np.std(ymat,axis=0)/np.sqrt(float(Nsims-1))
                            if show_legend:
                ...
                if False:
                    ...
                    if ('deltaZA','deltalin') in Pks.keys():
                        ymat = Pks[('deltaZA','deltalin')]['P']/np.sqrt(Pks[('deltaZA','deltaZA')]['P']*Pks[('deltalin','deltalin')]['P'])
                        ax.errorbar(kvec, np.mean(ymat,axis=0), yerr=np.std(ymat,axis=0)/np.sqrt(float(Nsims-1)),
                                    color='grey', ls='-', lw=1, label='$1-r^2(\\delta_Z,\\delta_1)$')
                ...
                for tfcounter, tf in enumerate([trf_specs[-1]]):
                    ...
                    if True:
                        if tf.target_field not in plotted_shotnoise_ids:
                            ...
                            my_one_over_nbar = 1.0 / nbar_of_cat['delta_h']
                            Ptarget = np.mean(stacked_pickles[(Rsmooth_lst[0],)]['Pkmeas'][(tf.target_field,tf.target_field)]['P'],axis=0)
                            if plt_type=='1mr2':
                                # 1-r^2 = Perr/Ptarget = 1/nbar_h / P_hh
                                yvec = my_one_over_nbar * eval_Pk_CIC_at_kvec(kvec) / Ptarget
                            elif plt_type=='r':
                                # |r| = sqrt(1-(1-r^2)) = sqrt(1-1/nbar_h / P_hh)
                                yvec = np.sqrt(1.0 - my_one_over_nbar * eval_Pk_CIC_at_kvec(kvec) / Ptarget)
                            ...
                            if show_legend:
                                ...
                                label = '_nolabel_'
                            ax.plot(kvec, yvec,                                    
                                    color='k', ls='-', lw=3, zorder=0, alpha=1,
                                    label=label)


                ## plot error of DM model
                DMerror_stacked_pickles = plot_DM_model_error(
                    ax, plt_type, plot_opts, pickle_path,  DMerror_stacked_pickles, 
                    show_legend2, sim_seeds=[400,401,402],)
                ...
                if plt_type == '1mr2':
                    if mass_weighted:
                        if False and np.isclose(float(log10M_min), 10.8):
                            legend = ax.legend(loc=legloc_1mr2,ncol=1,fontsize=constants.xylabelfs-4,frameon=False,handlelength=1.5, handletextpad=0.1,
                                      columnspacing=0.4)
                        else:
                            if np.isclose(float(log10M_min), 10.8):
                                ...
                                alpha = 1
                            legend = ax.legend(loc=legloc_1mr2,ncol=2,fontsize=constants.xylabelfs-4,
                                               frameon=True,handlelength=1.5, handletextpad=0.1,
                                               labelspacing=0.3,
                                               columnspacing=0.4, fancybox=True, framealpha=alpha)
                            legend.get_frame().set_linewidth(1)
                    else:
                        if show_legend:
                        ...
                        legend = ax.legend(loc=legloc_1mr2,ncol=1,fontsize=constants.xylabelfs-4,
                                           handlelength=2.3,handletextpad=0.2,
                ...
                if plt_type == 'r':
                    ...
                    if axcol == 0:
                        ...
                        ax.set_ylabel('$r_{\\!cc}$', fontsize=constants.xylabelfs)
                    ...
                    if axcol == 0:
                        ...
                        ax.set_ylabel('$P_\\mathregular{err}/P_\\mathregular{truth}\\,$ [%]', fontsize=constants.xylabelfs)
                    ax.set_yscale('log')
                ...
                # title
                if axrow in [0,3]:
                    make_title_1mr2(plot_title, log10M_min, log10M_max, my_one_over_nbar, redshift, ax=ax,
                                    ytitle=ytitle)
        ...
        fig.text(0.5, 0.97, 'FOF halos at $\\,z=$%.1f, no mass weighting' % redshift,
                 fontsize=constants.xylabelfs-4,
                 ha='center', va='center')
...
def get_manual_noise_over_poisson_curve_low_Mbin_with_Z(ax):
    ...
    mykvec = np.array([ 0.01603648,0.0280331, 0.03938502,0.05102672,0.06405809,0.07693044,
    ...
    myyvec = np.array([ 1.76993141,1.43805014,1.41427444,1.43880007,1.34132438,1.44560413,
...
def make_title(plot_title, log10M_min, log10M_max, my_one_over_nbar, redshift, ytitle=0.85, ax=None):
    title_str = None
    if not (log10M_min is None or log10M_max is None):
        if plot_title:
            if my_one_over_nbar is not None:
                if np.isclose(float(log10M_max), 16.0):
                    title_str = '$%s\\geq $%s$\\,%s$, $\\,\\bar n=$%.1e' % (
                            constants.log10M_string2, log10M_min, constants.hMsun_string,
                            1.0/my_one_over_nbar)
                else:
                    title_str = '$%s=$%s$-$%s\n$\\bar n=$%.1e' % (
                        constants.log10M_string2, log10M_min, log10M_max, 1.0/my_one_over_nbar)
    # write title as text field
    if ax is None:
        ax = plt.gca()        
    bbox_props = dict(boxstyle='round', facecolor='lightgrey', alpha=0.5, linewidth=0)
    mypatch = ax.text(0.95,ytitle, title_str, fontsize=constants.xylabelfs-4,
                      horizontalalignment='right',
                      transform=ax.transAxes, color='black', bbox=bbox_props)
    #mypatch.get_frame().set_linewidth(1)


    
def make_title_1mr2(plot_title, log10M_min, log10M_max, my_one_over_nbar, redshift, ytitle=0.85, ax=None):
    title_str = None
    if not (log10M_min is None or log10M_max is None):
        if plot_title:
            if my_one_over_nbar is not None:
    ...
    bbox_props = dict(boxstyle='round', facecolor='lightgrey', alpha=0.5, linewidth=0)
    if ytitle>0.5:
        mypatch = ax.text(0.05,ytitle, title_str, fontsize=constants.xylabelfs-4,
                          horizontalalignment='left', va='center',
                          transform=ax.transAxes, color='black', bbox=bbox_props)
    else:
        mypatch = ax.text(0.05,ytitle, title_str, fontsize=constants.xylabelfs-4,
                          horizontalalignment='left', va='center',
...
def plot_DM_model_error(ax, plt_type, plot_opts, pickle_path, 
    ...
    if DMerror_stacked_pickles is None:
        ...
        default_stack_kwargs = dict(        
            pickle_path=pickle_path, base_fname=pickle_fname,
            comp_key='flat_opts',
            outer_key_name=None,
            outer_key_values=None,
            call_wig_now_example=False,
            fname_pattern=r'^main_do_stage012_rec.*.pickle$',
            ignore_pickle_keys=['pickle_fname', 'opts',
                                "('stage0', 'out_rho_path')", 
                                "('stage0', 'in_path')", "('stage0', 'sim_irun')", "('stage0', 'ssseed')",
                                "('stage12', 'sim_seed')", "('stage12', 'ssseed')"],
            skip_keys_when_stacking=['opts','flat_opts','cat_infos'],
    ...
    if show_legend2:
        ...
        label = '_nolabel_'
    if plt_type == '1mr2':
        ax.loglog(kvec, np.mean(1.0-rmat**2, axis=0), label=label, **plt_kwargs)
    elif plt_type == 'r':
